		...
		<div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="first-slide" src="Produit/v1.jpg" alt="slide 5">
                    <div class="container">
                ...
                <div class="carousel-item">
                    <img class="second-slide" src="Produit/v2.jpg" alt="slide 4">
                    <div class="container">
                        <div class="carousel-caption">
                ...
                <div class="carousel-item">
                    <img class="third-slide" src="Produit/v3.jpg" alt="slide 3">
                    <div class="container">
                        <div class="carousel-caption">
                ...
                <div class="carousel-item">
                    <img class="4-slide" src="Produit/v4.jpg" alt="slide 4">
                    <div class="container">
                        <div class="carousel-caption">
                            <h1>One more for good measure.</h1>
                            <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
                ...
                <div class="carousel-item">
                    <img class="5-slide" src="Produit/v5.jpg" alt="slide 5">
                    <div class="container">
                        <div class="carousel-caption">
                            <h1>One more for good measure.</h1>
                            <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
                ...
                <div class="carousel-item">
                    <img class="6-slide" src="Produit/v6.jpg" alt="slide 6">
                    <div class="container">
                        <div class="carousel-caption">
                            <h1>One more for good measure.</h1>
                            <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
